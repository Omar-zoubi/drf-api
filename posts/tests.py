...
class PostModelTests(TestCase):
    ...
    def setUpTestData(cls):
        test_user = get_user_model().objects.create_user(username='Trytest',password='pass')
        test_user.save()

        test_post = Post.objects.create(
            author = test_user,
            title = 'New blog title:',
            body = 'description about the bloge'
        )
        test_post.save()
    ...
    def test_blog_content(self):
        ...
        self.assertEqual(str(post.author), 'Trytest')
        self.assertEqual(post.title, 'New blog title:')
        self.assertEqual(post.body, 'description about the bloge')
